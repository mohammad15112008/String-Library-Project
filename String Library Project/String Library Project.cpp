...

{
    ...
    cout << "Number of words: " <<
        clsString::CountWords("Mohammad Salameh Obeidat") << endl;
    ...
    cout << "Capital Letters count : "
        << clsString::CountLetters("Mohammad Salameh Obeidat", clsString::CapitalLetters)
        << endl << endl;
    ...
    //Tirms
    String3.Value = "    Mohammad Salameh Obeidat     ";
